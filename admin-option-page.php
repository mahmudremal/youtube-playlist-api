					...
					<div class="fwp-section mb50">
                        ...
                        <?php if( 1 == 3 ) : ?>
												<div class="tooltip-header">
													...
													<a href="javascript:void(0)" class="tootip-link"><i class="dashicons-before dashicons-admin-links"></i></a>
												</div>
                        <?php endif; ?>
												<div class="tooltip-body">
													<?php echo esc_html( ( isset( $snippet[ 'description' ] ) && ! empty( $snippet[ 'description' ] ) && ! is_array( $snippet[ 'description' ] ) ) ? substr( $snippet[ 'description' ], 0, 120 ) : __( 'Watch', 'domain' ) ); ?>
												</div>
											</div>
										</div>
										<?php endif; ?>
