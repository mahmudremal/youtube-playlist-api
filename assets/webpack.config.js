...
const entry = {
	// users: [ "regenerator-runtime/runtime.js", JS_DIR + '/users.js' ],
	// serviceWorker: [ "regenerator-runtime/runtime.js", JS_DIR + '/serviceWorker.js' ],
	
	// popup: [ "regenerator-runtime/runtime.js", JS_DIR + '/popup.js' ],
	// upgrade: [ "regenerator-runtime/runtime.js", JS_DIR + '/upgrade.js' ],
	// content: [ "regenerator-runtime/runtime.js", JS_DIR + '/content.js' ],

	main: [ "regenerator-runtime/runtime.js", JS_DIR + '/main.js' ],
	// inbox: [ "regenerator-runtime/runtime.js", JS_DIR + '/inbox.js' ],
};
