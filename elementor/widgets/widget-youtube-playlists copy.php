  ...
  public function get_style_depends() {
    ...
    $this->ytjson = 
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Filter Playlists', 'youtube-playlist-api-integration' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
    $this->add_control(
			'include',
			[
				'label' => esc_html__( 'Include', 'youtube-playlist-api-integration' ),
				'type' => \Elementor\Controls_Manager::SELECT2,
				'multiple' => true,
				'options' => apply_filters( 'elementor/widgets/youtube_playlist/include/select', [] ),
				'label_block' => true,
				// 'default' => '',
				'description' => esc_html__( 'Select playlist only those should be included here. If you willling to display all except some specific item, just leave blank here, and select from excluded list to exclude.', 'youtube-playlist-api-integration' ),
			]
		);
    $this->add_control(
			'exclude',
			[
				'label' => esc_html__( 'Exclude', 'youtube-playlist-api-integration' ),
				'type' => \Elementor\Controls_Manager::SELECT2,
				'multiple' => true,
				'options' => apply_filters( 'elementor/widgets/youtube_playlist/exclude/select', [] ),
				'label_block' => true,
				// 'default' => '',
				'description' => esc_html__( 'Select playlist only those should be excluded here.', 'youtube-playlist-api-integration' ),
			]
		);
