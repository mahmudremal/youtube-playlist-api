            ...
            <div class="fwp-col-md-12">
              <div class="fwp-tool__card fwp-tool__card--flex">
                <div class="content fwp-col-sm-12">
                  <h3><?php esc_html_e( 'Youtube PlayLists Shortcodes.', 'youtube-playlist-api-integration' ); ?></h3>
                  <p>
                    <?php echo sprintf( __( 'Shortcodes are used like a hook, or if I explain it simply, shortcode are like a function. Just use it anywhere anytime. How you can use it?%sFor this you\'ve use shortcode widget. Please see this three screenshot below.', 'youtube-playlist-api-integration' ), '<br>' ); ?>
                  </p>
                  <div class="line"></div>
                  ...
                  <!-- <div class="line"></div>
                  <p>
                    <?php echo sprintf( __( 'If you use WordPress default editor, so follow these screenshots.', 'youtube-playlist-api-integration' ), '<br>' ); ?>
                  </p>
                  <div class="fwp-flex shortcodes-tutorial-img">
                    <div class="fwp-col-sm-4">
                  ...
                  <div class="line"></div>
                  <p>
                    <?php echo sprintf( esc_html( 'Youtube Gallery shortcode name is %syoutube_gallery%s. and it is used under a bracket( third ).%sE.G. [youtube_gallery]', 'youtube-playlist-api-integration' ), '<strong>', '</strong>', '<br />' ); ?><br />
                    <?php echo sprintf( esc_html( 'options and paramiters:%s', 'youtube-playlist-api-integration' ), '<br />' ); ?><br />
                    <?php echo sprintf( esc_html( '%schannel%s: is used to identify specific channel ( required ). If you given it blank, it will return your first playlist.', 'youtube-playlist-api-integration' ), '<strong>', '</strong>' ); ?><br />
