                  ...
                  <div class="fwp-tool__card">
                    <div class="content mt30">
                      <div class="align__center mb20">
                        <input type="text" name="settings[youtubeapi]" id="settings-youtubeapi" placeholder="<?php esc_attr_e( "Google API key here.", 'youtube-playlist-api-integration' ); ?>" value="<?php echo esc_html( $youtubeapi ); ?>" required>
                      </div>
                    </div>
                  </div>
              </div>
